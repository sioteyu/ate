...
public class GUI {
    ...
    private JFormattedTextField motorAmountField;
    private JFormattedTextField motorSpeedField;
    ...
    public void initGUI() {
        frame = createJFrame("Artificial Traffic Enforcer");
    ...
    public synchronized void count(CountVehicles countVehicles) throws WriteException {
        if (countVehicles.isVehicleToAdd()) {
            ...
            switch (vehicleType) {
                case "motorBike":
                    motor++;
                    motorAmountField.setValue(cars);
                case "Car":
                    cars++;
    ...
    public synchronized void speedMeasure(CountVehicles countVehicles) throws WriteException {
        if (!speed.isEmpty()) {
            ...
            if (countVehicles.isToSpeedMeasure()) {
                ...
                switch (carType) {
                    case "motorBike":
                        sumSpeedMotor = sumSpeedMotor + currentSpeed;
                        double avgspeed1 = sumSpeedMotor / divisorMotor;
                        divisorMotor++;
                        motorSpeedField.setValue(avgspeed1);
                        break;
                    case "Car":
                        sumSpeedCar = sumSpeedCar + currentSpeed;
                        double avgspeed2 = sumSpeedCar / divisorCar;
                        divisorCar++;
                        carsSpeedField.setValue(avgspeed2);
                        break;
                    case "Van":
                        sumSpeedVan = sumSpeedVan + currentSpeed;
                        double avgspeed3 = sumSpeedVan / divisorVan;
                        divisorVan++;
                        vansSpeedField.setValue(avgspeed3);
                        break;
                    case "Lorry":
                        sumSpeedLorry = sumSpeedLorry + currentSpeed;
                        double avgspeed4 = sumSpeedLorry / divisorLorry;
                        divisorLorry++;
                        lorriesSpeedField.setValue(avgspeed4);
                        break;
                }
...
//        setupBGSvisibility(frame);
    ...
    private void infoMotor(JFrame frame) {
        ...
        JLabel carsLabel = new JLabel("Motor", JLabel.CENTER);
        carsLabel.setFont(new Font("defaut", Font.BOLD, 12));

        NumberFormat numberFormat = NumberFormat.getNumberInstance();
        motorAmountField = new JFormattedTextField(numberFormat);
        motorAmountField.setValue(new Integer(0));
        motorAmountField.setBackground(Color.YELLOW);
        motorAmountField.setEditable(false);
        motorAmountField.setPreferredSize(new Dimension(50, 20));
        motorAmountField.setHorizontalAlignment(JFormattedTextField.CENTER);

        motorSpeedField = new JFormattedTextField(numberFormat);
        motorSpeedField.setValue(new Integer(0));
        motorSpeedField.setBackground(Color.GREEN);
        motorSpeedField.setEditable(false);
        motorSpeedField.setPreferredSize(new Dimension(50, 20));
        motorSpeedField.setHorizontalAlignment(JFormattedTextField.CENTER);
        ...
        c.gridy = 12;
        frame.add(motorAmountField, c);

        c.gridy = 13;
        frame.add(motorSpeedField, c);
    }
    ...
    private void infoLorries(JFrame frame) {
        ...
        JLabel lorriesLabel = new JLabel("Trucks", JLabel.CENTER);
